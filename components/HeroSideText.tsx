    ...
    return (
        <div
            className="flex flex-col items-center md:items-start
                text-center md:text-left gap-4 mt-6 md:-mt-10"
        >
            ...
            <h1
                className=" text-3xl md:text-5xl font-semibold bg-linear-to-b from-white to-white/60 
                    bg-clip-text text-transparent leading-tight"
            >
                Prathamesh Dhadankar
            </h1>

            <p className="text-neutral-400 text-base sm:text-lg lg:text-xl max-w-md">
